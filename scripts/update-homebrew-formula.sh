...
FORMULA_CLASS="${FORMULA_CLASS:-Gwtm}"
BINARY_NAME="${BINARY_NAME:-gwtm}"
ASSET_BASENAME="${ASSET_BASENAME:-gwtm}"
DESCRIPTION="${DESCRIPTION:-Git worktree manager for local multi-project workflows}"
VERSION=""
